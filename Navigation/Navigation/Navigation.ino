...
#endif
#ifdef USE_SR04
#define pingPin    11                        //digital pin number on the arduino board that has the ping data line plugged into it
#define triggerPin 12                        //digital pin number on the arduino board that has the trigger data line plugged into it
#endif
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define RAservoPin 9                       // right ankle servo pin
#define RHservoPin 6                       // right hip servo pin
#define LAservoPin 10                      // left ankle servo pin
#define LHservoPin 5                       // left hip servo pin
...
// Calibration
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int calibration[4] = {-300, -1500, -400, -900 };
...
int larsonSize = (sizeof(larson)/sizeof(byte));  // size of the array with the larson data
int larsonIdx  = 0;                              // index to the next element in the array to display
...
void UpdateLarsonScanner()
{
  ...
  if (currentMillis - previousLarsonMillis >= 75) {
    previousLarsonMillis = currentMillis;
    if (larsonIdx >= larsonSize) {
      larsonIdx = 0;
    }
    digitalWrite(latchPin, LOW);
    shiftOut(dataPin, clockPin, LSBFIRST, larson[larsonIdx++]);
